...
namespace Testing
{
	sealed partial class TestLoggerCore : Testing.ITestLogger
	{
		...
		static readonly System.Action<Microsoft.Extensions.Logging.ILogger, string, int, bool, System.Exception?> _log_EventId_3Action = Microsoft.Extensions.Logging.LoggerMessage.Define<string, int, bool>(Microsoft.Extensions.Logging.LogLevel.Critical, new Microsoft.Extensions.Logging.EventId(100, "Test.Log_EventId_3"), "Test.Log_EventId_3: stringParam: {StringParam}, intParam: {IntParam}, boolParam: {BoolParam}");
		static readonly System.Action<Microsoft.Extensions.Logging.ILogger, string, int, bool, System.Exception?> _log_MessageTemplate_1Action = Microsoft.Extensions.Logging.LoggerMessage.Define<string, int, bool>(Microsoft.Extensions.Logging.LogLevel.Critical, new Microsoft.Extensions.Logging.EventId(1635815403, "Test.Log_MessageTemplate_1"), "template");
		static readonly System.Action<Microsoft.Extensions.Logging.ILogger, string, int, bool, System.Exception?> _log_MessageTemplate_2Action = Microsoft.Extensions.Logging.LoggerMessage.Define<string, int, bool>(Microsoft.Extensions.Logging.LogLevel.Critical, new Microsoft.Extensions.Logging.EventId(1652593022, "Test.Log_MessageTemplate_2"), "template");
		static readonly System.Action<Microsoft.Extensions.Logging.ILogger, string, int, bool, System.Exception?> _log_MessageTemplate_3Action = Microsoft.Extensions.Logging.LoggerMessage.Define<string, int, bool>(Microsoft.Extensions.Logging.LogLevel.Critical, new Microsoft.Extensions.Logging.EventId(1669370641, "Test.Log_MessageTemplate_3"), "template");
