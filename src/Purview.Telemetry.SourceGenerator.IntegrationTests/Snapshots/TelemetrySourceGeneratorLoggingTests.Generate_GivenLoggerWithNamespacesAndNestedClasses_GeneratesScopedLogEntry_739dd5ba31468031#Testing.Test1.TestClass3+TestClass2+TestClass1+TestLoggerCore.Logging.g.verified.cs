//HintName: Testing.Test1.TestClass3+TestClass2+TestClass1+TestLoggerCore.Logging.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Testing.Test1
{
	partial class TestClass1
	{
		partial class TestClass2
		{
			...
			{
				sealed partial class TestLoggerCore : Testing.Test1.TestClass3+TestClass2+TestClass1+ITestLogger
				{
					const Microsoft.Extensions.Logging.LogLevel DEFAULT_LOGLEVEL = Microsoft.Extensions.Logging.LogLevel.Information;

					readonly Microsoft.Extensions.Logging.ILogger<Testing.Test1.TestClass3+TestClass2+TestClass1+ITestLogger> _logger;
					...
					public TestLoggerCore(Microsoft.Extensions.Logging.ILogger<Testing.Test1.TestClass3+TestClass2+TestClass1+ITestLogger> logger)
					{
						_logger = logger;
					}
