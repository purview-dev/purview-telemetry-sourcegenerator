...
namespace Testing
{
	...
	sealed partial class TestActivitiesCore : global::Testing.ITestActivities
	{
		...
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("Purview.Telemetry.SourceGenerator", "0.1.0.0")]
		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
		public void Event(System.Diagnostics.Activity? activity, string? statusDescription)
		{
			if (!_activitySource.HasListeners())
			{
				return;
			...
			if (activity != null)
			{
				...
				global::System.Diagnostics.ActivityEvent activityEventEvent = new(name: "Event", timestamp: default, tags: default);

				activity.AddEvent(activityEventEvent);

				activity.SetStatus(global::System.Diagnostics.ActivityStatusCode.Error, statusDescription);
			}
		}

		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("Purview.Telemetry.SourceGenerator", "0.1.0.0")]
		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
		public void Event2(System.Diagnostics.Activity? activity, string statusDescription_another)
		{
			if (!_activitySource.HasListeners())
			{
				return;
			...
			if (activity != null)
			{
				...
				global::System.Diagnostics.ActivityEvent activityEventEvent2 = new(name: "Event2", timestamp: default, tags: default);

				activity.AddEvent(activityEventEvent2);

				activity.SetStatus(global::System.Diagnostics.ActivityStatusCode.Error, statusDescription_another);
			}
		}
