...
sealed partial class LoggingTelemetryCore : ILoggingTelemetry
{
	...
	static readonly System.Func<Microsoft.Extensions.Logging.ILogger, System.Guid, System.IDisposable?> _processingWorkItemAction = Microsoft.Extensions.Logging.LoggerMessage.DefineScope<System.Guid>("ProcessingWorkItem: Id = {Id}");
	...
	static readonly System.Action<Microsoft.Extensions.Logging.ILogger, System.Exception?> _failedToProcessWorkItemAction = Microsoft.Extensions.Logging.LoggerMessage.Define(Microsoft.Extensions.Logging.LogLevel.Error, new Microsoft.Extensions.Logging.EventId(1082978768, "FailedToProcessWorkItem"), "FailedToProcessWorkItem");
	static readonly System.Action<Microsoft.Extensions.Logging.ILogger, bool, System.TimeSpan, System.Exception?> _processingCompleteAction = Microsoft.Extensions.Logging.LoggerMessage.Define<bool, System.TimeSpan>(Microsoft.Extensions.Logging.LogLevel.Information, new Microsoft.Extensions.Logging.EventId(1684975581, "ProcessingComplete"), "ProcessingComplete: Success = {Success}, Duration = {Duration}");

	public LoggingTelemetryCore(global::Microsoft.Extensions.Logging.ILogger<ILoggingTelemetry> logger)
	{
		_logger = logger;
	}
