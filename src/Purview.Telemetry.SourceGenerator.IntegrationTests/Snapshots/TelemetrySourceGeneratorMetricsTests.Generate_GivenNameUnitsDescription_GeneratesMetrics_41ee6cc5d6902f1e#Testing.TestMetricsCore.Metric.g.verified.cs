...
namespace Testing
{
	sealed partial class TestMetricsCore : Testing.ITestMetrics
	{
		...
		System.Diagnostics.Metrics.ObservableCounter<System.Int32>? _metricInstrument = null;
		...
		public void Metric(System.Func<int> f, int intParam, bool boolParam)
		{
			...
			_metricInstrument = _meter.CreateObservableCounter<System.Int32>("an-observablecounter-name-property", f, unit: "pie-property", description: "pie sales per-capita-property.", tags: metricTagList);
		}
	}
}
