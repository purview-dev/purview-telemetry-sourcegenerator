...
namespace Testing
{
	sealed partial class TestLoggerCore : Testing.ITestLogger
	{
		...
		static readonly System.Action<Microsoft.Extensions.Logging.ILogger, System.Collections.Generic.IDictionary<string, int>, System.Exception?> _logEntryWithGenericTypeParamAction = Microsoft.Extensions.Logging.LoggerMessage.Define<System.Collections.Generic.IDictionary<string, int>>(Microsoft.Extensions.Logging.LogLevel.Information, new Microsoft.Extensions.Logging.EventId(842060863, "Test.LogEntryWithGenericTypeParam"), "Test.LogEntryWithGenericTypeParam: paramName: {ParamName}");
