...
namespace Testing
{
	sealed partial class TestLoggerCore : Testing.ITestLogger
	{
		...
		static readonly System.Action<Microsoft.Extensions.Logging.ILogger, string, int, bool, System.Exception?> _log_EventId_3Action = Microsoft.Extensions.Logging.LoggerMessage.Define<string, int, bool>(Microsoft.Extensions.Logging.LogLevel.Critical, new Microsoft.Extensions.Logging.EventId(100, "Log_EventId_3"), "Log_EventId_3: StringParam = {StringParam}, IntParam = {IntParam}, BoolParam = {BoolParam}");
