...
namespace Testing
{
	sealed partial class TestMetricsCore : Testing.ITestMetrics
	{
		...
		readonly System.Diagnostics.Metrics.UpDownCounter<System.Int32> _metricInstrument;
		...
		public TestMetricsCore(System.Diagnostics.Metrics.IMeterFactory meterFactory)
		{
			...
			_metricInstrument = _meter.CreateUpDownCounter<System.Int32>(name: "an-updown-counter-name-param", unit: "sponges-param", description: "sponge sales per-capita-param.", tags: null);
		}
