...
namespace Testing
{
	...
	sealed partial class TestTelemetryCore : global::Testing.ITestTelemetry
	{
		...
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("Purview.Telemetry.SourceGenerator", "0.1.0.0")]
		[global::System.Runtime.CompilerServices.MethodImpl(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
		public void Event(System.Diagnostics.Activity? activity, string stringParam, int intParam, bool boolParam, System.Exception anException, bool escape)
		{
			if (!_activitySource.HasListeners())
			{
				return;
			...
			if (activity != null)
			{
				...
				RecordExceptionInternal(activity: activity, exception: anException, escape: escape);
