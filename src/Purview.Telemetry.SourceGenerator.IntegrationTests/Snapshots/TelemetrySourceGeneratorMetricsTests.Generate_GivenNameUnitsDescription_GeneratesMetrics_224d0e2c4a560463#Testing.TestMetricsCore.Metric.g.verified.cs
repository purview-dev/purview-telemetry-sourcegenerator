...
namespace Testing
{
	sealed partial class TestMetricsCore : Testing.ITestMetrics
	{
		...
		public void Metric(System.Func<int> f, int intParam, bool boolParam)
		{
			...
			_metricInstrument = _meter.CreateObservableCounter<System.Int32>("an-observablecounter-name-param", f, unit: "pie-param", description: "pie sales per-capita-param.", tags: metricTagList);
		}
	}
}
