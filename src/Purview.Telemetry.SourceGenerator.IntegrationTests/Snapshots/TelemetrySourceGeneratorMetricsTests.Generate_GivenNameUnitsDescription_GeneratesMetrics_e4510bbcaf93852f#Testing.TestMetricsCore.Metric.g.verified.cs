...
namespace Testing
{
	sealed partial class TestMetricsCore : Testing.ITestMetrics
	{
		...
		System.Diagnostics.Metrics.ObservableGauge<System.Int32>? _metricInstrument = null;
		...
		public void Metric(System.Func<System.Diagnostics.Metrics.Measurement<System.Int32>> f, int intParam, bool boolParam)
		{
			...
			_metricInstrument = _meter.CreateObservableGauge<System.Int32>("an-observablegauge-name-property", f, unit: "biscuits-property", description: "biscuit sales per-capita-property.", tags: metricTagList);
		}
	}
}
