...
sealed public class ActivitySourceTargetAttribute : Attribute {
	/// <summary>
	/// Constructs a new <see cref="ActivitySourceTargetAttribute"/>.
	/// </summary>
	public ActivitySourceTargetAttribute() {
	}
	...
	public ActivitySourceTargetAttribute(string activitySource, string? className = null) {
