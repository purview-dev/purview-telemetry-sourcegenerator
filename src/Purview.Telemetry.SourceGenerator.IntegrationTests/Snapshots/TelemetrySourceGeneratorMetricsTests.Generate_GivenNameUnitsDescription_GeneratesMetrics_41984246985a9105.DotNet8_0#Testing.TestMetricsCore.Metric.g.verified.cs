...
namespace Testing
{
	sealed partial class TestMetricsCore : Testing.ITestMetrics
	{
		...
		public void Metric(System.Func<System.Collections.Generic.IEnumerable<System.Diagnostics.Metrics.Measurement<System.Int32>>> f, int intParam, bool boolParam)
		{
			...
			_metricInstrument = _meter.CreateObservableUpDownCounter<System.Int32>("an-observableupdowncounter-name-param", f, unit: "beer-param", description: "beer sales per-capita-param."
#if !NET7_0
				, tags: metricTagList
#endif
			);
