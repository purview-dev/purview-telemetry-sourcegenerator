...
namespace Testing
{
	sealed partial class TestLoggerCore : Testing.ITestLogger
	{
		...
		static readonly System.Action<Microsoft.Extensions.Logging.ILogger, System.Collections.Generic.List<string>, System.Exception?> _logEntryWithGenericTypeParamAction = Microsoft.Extensions.Logging.LoggerMessage.Define<System.Collections.Generic.List<string>>(Microsoft.Extensions.Logging.LogLevel.Information, new Microsoft.Extensions.Logging.EventId(842060863, "LogEntryWithGenericTypeParam"), "Test.LogEntryWithGenericTypeParam: paramName: {ParamName}");
