	...
	sealed partial class TestActivitiesCore : Testing.ITestActivities
	{
		...
		public void Event(System.Diagnostics.Activity? activity, string? statusDescription)
		{
			...
			if (activity != null)
			{
				...
				activity.SetStatus(System.Diagnostics.ActivityStatusCode.Error, statusDescription);
			}
		}
		...
		public void Event2(System.Diagnostics.Activity? activity, string statusDescription_another)
		{
			...
			if (activity != null)
			{
				...
				System.Diagnostics.ActivityEvent activityEventEvent2 = new System.Diagnostics.ActivityEvent(name: "Event2", timestamp: default, tags: default);

				activity.AddEvent(activityEventEvent2);

				activity.SetStatus(System.Diagnostics.ActivityStatusCode.Error, statusDescription_another);
			}
		}
