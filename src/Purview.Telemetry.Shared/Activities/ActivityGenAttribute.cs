...
sealed public class ActivityGenAttribute : Attribute {

	public ActivityGenAttribute() {
	}

	public ActivityGenAttribute(string name) {
		Name = name;
	}

	public ActivityGenAttribute(ActivityGeneratedKind kind) {
		Kind = kind;
	}

	public ActivityGenAttribute(string name, ActivityGeneratedKind kind, bool createOnly = false) {
		Name = name;
		Kind = kind;
