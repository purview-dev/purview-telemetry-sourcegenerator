...
namespace Testing
{
	sealed partial class TestLoggerCore : Testing.ITestLogger
	{
		...
		static readonly System.Action<Microsoft.Extensions.Logging.ILogger, string, int, bool, System.Exception?> _logAction = Microsoft.Extensions.Logging.LoggerMessage.Define<string, int, bool>(Microsoft.Extensions.Logging.LogLevel.Information, default, "TestLoggerCore.custom-log-entry-name: stringParam: {StringParam}, intParam: {IntParam}, boolParam: {BoolParam}");
