...
#if NET
					return string.Create(global::System.Globalization.CultureInfo.InvariantCulture, $"LogWeatherWithOmit: Weather = {v0}");
#else
					return global::System.FormattableString.Invariant($"LogWeatherWithOmit: Weather = {v0}");
#endif
				}
			);
