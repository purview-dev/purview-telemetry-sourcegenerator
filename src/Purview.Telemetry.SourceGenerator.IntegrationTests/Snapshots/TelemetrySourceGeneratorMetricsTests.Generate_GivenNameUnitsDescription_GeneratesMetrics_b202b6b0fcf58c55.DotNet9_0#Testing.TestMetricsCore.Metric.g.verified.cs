...
namespace Testing
{
	...
	sealed partial class TestMetricsCore : global::Testing.ITestMetrics
	{
		...
		global::System.Diagnostics.Metrics.ObservableCounter<int>? _metricInstrument = null;
		...
		public void Metric(System.Func<int> f, int intParam, bool boolParam)
		{
			...
			_metricInstrument = _meter.CreateObservableCounter<int>("an-observablecounter-name-param", f, unit: "pie-param", description: "pie sales per-capita-param."
				, tags: metricTagList
			);
		}
	}
