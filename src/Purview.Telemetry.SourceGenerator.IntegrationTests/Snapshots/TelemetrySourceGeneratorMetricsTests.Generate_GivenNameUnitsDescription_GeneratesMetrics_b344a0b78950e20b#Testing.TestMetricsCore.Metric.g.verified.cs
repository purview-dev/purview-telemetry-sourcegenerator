...
namespace Testing
{
	sealed partial class TestMetricsCore : Testing.ITestMetrics
	{
		...
		public void Metric(System.Func<System.Diagnostics.Metrics.Measurement<System.Int32>> f, int intParam, bool boolParam)
		{
			...
			_metricInstrument = _meter.CreateObservableGauge<System.Int32>("an-observablegauge-name-param", f, unit: "biscuits-param", description: "biscuit ake sales per-capita-param.", tags: metricTagList);
		}
	}
}
