...
namespace Testing.Test1
{
	partial class TestClass1
	{
		partial class TestClass2
		{
			...
			{
				sealed partial class TestLoggerCore : Testing.Test1.TestClass1.TestClass2.TestClass3.ITestLogger
				{
					readonly Microsoft.Extensions.Logging.ILogger<Testing.Test1.TestClass1.TestClass2.TestClass3.ITestLogger> _logger = default!;
					...
					public TestLoggerCore(Microsoft.Extensions.Logging.ILogger<Testing.Test1.TestClass1.TestClass2.TestClass3.ITestLogger> logger)
					{
						_logger = logger;
					}
